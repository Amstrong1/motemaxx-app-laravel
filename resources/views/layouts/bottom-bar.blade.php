<section id="bottom-navigation" class="py-4 block fixed inset-x-0 bottom-0 z-10 shadow"
    ...
    <div id="tabs" class="flex justify-between">
        ...
        @else
            ...
            <span class="tab tab-home block uppercase">Acceuil</span>
        </a>
        ...
        {{-- <a href="{{ route('consultation.index') }}"
            ...
            <span class="tab tab-explore block uppercase">Consultations</span>
        </a> --}}
        ...
        <a href="{{ route('chat') }}"
            ...
            <span class="tab tab-kategori block uppercase">ChatBot</span>
        </a>
    </div>
</section>
